...
mp_soma = 1          # 2 graphs : Membrane potential in soma and at one point in dendrite. Membrane potentials at each synapse.
current_soma = 1     # All currents in soma and at one point in dendrite
rev_pot_soma = 1     # Reversal potentials in soma and at one point in dendrite
...
if chloride == 1:
    ...
    ax[0,0].set_ylim(min(soma_ko[int(decal/5):]), max(soma_ko[int(decal/5):]))
    ax[0,1].set_ylim(min(soma_cli[int(decal/5):]), max(soma_cli[int(decal/5):]))
    ax[1,0].set_ylim(min(soma_nai[int(decal/5):]), max(soma_nai[int(decal/5):]))
    ax[1,1].set_ylim(min(soma_ki[int(decal/5):]), max(soma_ki[int(decal/5):]))
...
if mp_soma == 1:
    ...
    plt.ylim(min(soma_v[int(decal/5):]), max(soma_v[int(decal/5):]))
...
if current_soma == 1:
    ...
    plt.xlim(xlimit_min, xlimit_max)
    plt.ylim(min([min(soma_icl[int(decal/5):]), min(soma_ik[int(decal/5):]), min(soma_ina[int(decal/5):])]),
            max([max(soma_icl[int(decal/5):]), max(soma_ik[int(decal/5):]), max(soma_ina[int(decal/5):])]))
    plt.legend()
...
if rev_pot_soma == 1:
    ...
    plt.xlim(xlimit_min, xlimit_max)
    plt.ylim(min([min(soma_ecl[int(decal/5):]), min(soma_ek[int(decal/5):]), min(soma_ena[int(decal/5):]), min(soma_v[int(decal/5):])]),
            max([max(soma_ecl[int(decal/5):]), max(soma_ek[int(decal/5):]), max(soma_ena[int(decal/5):]), max(soma_v[int(decal/5):])]))
...
if ik_dend_soma_add_check == 1:
    max_ik_soma = max([max(soma_ik[int(decal/5):]), max(soma_ik_hh[int(decal/5):]),
                        ...
                        max(soma_ik_nkcc1[int(decal/5):]), max(soma_ik_leak[int(decal/5):])])
    min_ik_soma = min([min(soma_ik[int(decal/5):]), min(soma_ik_hh[int(decal/5):]),
                        ...
                        min(soma_ik_nkcc1[int(decal/5):]), min(soma_ik_leak[int(decal/5):])])
...
if ina_dend_soma_add_check == 1:
    max_ina_soma = max([max(soma_ina[int(decal/5):]), max(soma_ina_hh[int(decal/5):]),
                        ...
                        max(soma_ina_nkcc1[int(decal/5):]), max(soma_ina_leak[int(decal/5):])])
    min_ina_soma = min([min(soma_ina[int(decal/5):]), min(soma_ina_hh[int(decal/5):]),
                        min(soma_ina_nak[int(decal/5):]),
                        min(soma_ina_nkcc1[int(decal/5):]), min(soma_ina_leak[int(decal/5):])])
