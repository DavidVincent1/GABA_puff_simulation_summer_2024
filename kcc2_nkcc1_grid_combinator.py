...
# Pickle files ----------------------------------------------------------------------------------------------
with open('dataset\pickle_kcc2=1e-06-0.0005_nkcc1=1e-06-0.0005_gclc2=0.0\Stable_chloride.pickle', 'rb') as f:
    fig1 = pickle.load(f)
with open('dataset\pickle_kcc2=1e-06-0.0005_nkcc1=1e-06-0.0005_gclc2=1e-06\Stable_chloride.pickle', 'rb') as f:
    fig2 = pickle.load(f)
with open('dataset\pickle_kcc2=1e-06-0.0005_nkcc1=1e-06-0.0005_gclc2=5e-06\Stable_chloride.pickle', 'rb') as f:
    fig3 = pickle.load(f)
with open('dataset\pickle_kcc2=1e-06-0.0005_nkcc1=1e-06-0.0005_gclc2=5e-06\Stable_chloride.pickle', 'rb') as f:
    fig4 = pickle.load(f)
...
Unkcc1_label = [f'{val:.2f}' for val in Unkcc1]
Ukcc2_label = [f'{val:.2f}' for val in Ukcc2]
...
for i in range(len(data1)):
    for j in range(len(data1[i])):
        text = axes[0, 0].text(j, i, f'{data1[i, j]:.3f}', ha="center", va="center", color="w", fontsize=14)
...
for i in range(len(data2)):
    for j in range(len(data2[i])):
        text = axes[0, 1].text(j, i, f'{data2[i, j]:.3f}', ha="center", va="center", color="w", fontsize=14)
...
for i in range(len(data3)):
    for j in range(len(data3[i])):
        text = axes[1, 0].text(j, i, f'{data3[i, j]:.3f}', ha="center", va="center", color="w", fontsize=14)
...
for i in range(len(data4)):
    for j in range(len(data4[i])):
        text = axes[1, 1].text(j, i, f'{data4[i, j]:.3f}', ha="center", va="center", color="w", fontsize=14)

for i in range(2):
    for j in range(2):
        axes[i,j].set_xlabel(r"$U_{nkcc1}$ [mM/ms]", fontsize=18)
        axes[i,j].set_ylabel(r"$U_{kcc2}$ [mM/ms]", fontsize=18)
